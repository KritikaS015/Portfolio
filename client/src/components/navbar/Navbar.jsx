...
export default function Navbar(props) {
  ...
  return (
    <nav className="flex justify-between items-center h-[8vh] bg-black sticky top-0 z-10">
      <div className="flex items-center h-full px-4 md:px-8 lg:px-12">
        <i
          ...
          onClick={toggleMenu}
        ></i>
        <span className="ml-4 text-white font-bold text-[30px] sm:text-4xl md:text-4xl ">
          {props.title}
        </span>
      </div>
      <div
        className={md.matches ? "flex md:items-center md:space-x-8" : "hidden"}
      >
